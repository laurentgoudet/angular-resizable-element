import { ContentChildren, Directive, ElementRef, EventEmitter, HostListener, Input, NgModule, NgZone, Output, Renderer2 } from '@angular/core';
...
var Resizable = (function () {
    ...
    Resizable.prototype.ngOnInit = function () {
        ...
        mouseMove.throttle(function (val) { return interval$1(MOUSE_MOVE_THROTTLE_MS); }).subscribe(function (_a) {
            var clientX = _a.clientX, clientY = _a.clientY;
        ...
        var /** @type {?} */ mousedrag = this.mousedown.flatMap(function (startCoords) {
            ...
            return merge$1(mouseMove.take(1).map(function (coords) { return [, coords]; }), mouseMove.pairwise()).map(function (_a) {
            ...
            }).takeUntil(merge$1(_this.mouseup, _this.mousedown));
        }).filter(function () { return !!currentResize; });
...
export { Resizable, ResizeHandle, ResizableModule };
